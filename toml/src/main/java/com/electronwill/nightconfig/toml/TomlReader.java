...
public final class TomlReader {
	 ...
	 *
	 * @param input               the CharacterInput to read the data from
	 * @param strictAsciiBareKeys true to allow only strict bare keys, false to allow lenient ones.
	 */
	public TomlReader(CharacterInput input, boolean strictAsciiBareKeys) {
		this.input = input;
