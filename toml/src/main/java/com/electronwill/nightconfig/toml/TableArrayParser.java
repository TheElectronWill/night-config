 ...
 * @see <a href="https://github.com/toml-lang/toml#user-content-array-of-tables">TOML
 * specification - Arrays of tables</a>
 */
final class TableArrayParser {
	static List<String> parseElementName(CharacterInput input, TomlParser parser) {
		...
		// Special case for the first part because we need to forbid [[]] and [[ spaces ]]
		char first = input.readChar();
		if (first == ']') {
			throw new ParsingException(
					"The name of an element in an array of tables must not be empty.");
		}
