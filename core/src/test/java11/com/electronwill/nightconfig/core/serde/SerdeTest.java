...
public final class SerdeTest {
	...
	static class Simple {
		...
		String nullString;
		UUID uid = UUID.fromString("3d294d89-4a6d-41bb-9946-a73a019718d3");
		...
		public boolean equals(Object obj) {
			...
			if (nullString == null) {
				...
				return false;
			if (!Objects.equals(uid, other.uid)) {
				return false;
			}
		...
		@Override
		public String toString() {
			return "Simple [myString=" + myString + ", nullString=" + nullString + ", uid=" + uid + ", listOfStrings="
					+ listOfStrings + ", heterogeneousList=" + heterogeneousList + ", subConfig=" + subConfig + "]";
		}
		...
		static {
			...
			SERIALIZED.set("uid", "3d294d89-4a6d-41bb-9946-a73a019718d3");
	...
	public void testArrayValues() throws Exception {
		...
		var serialized2 = ser.serialize(new ArrayValues<String>(), CommentedConfig::inMemory);
	...
	static class SimpleAnnotations {
		...
		static {
			...
			SERIALIZED.setComment("nested",
					"Here's a comment with multiple lines.\nSee, a second line is right there!");
		}
	}
	...
	static class EnumValues {
		final MyEnum enumStr = MyEnum.B;
		// final MyEnum enumInt = MyEnum.B;
		...
		@Override
		public String toString() {
			return "EnumValues [enumStr=" + enumStr + "]";
		}

		static final Config SERIALIZED;
		static {
			SERIALIZED = Config.inMemory();
			SERIALIZED.set("enumStr", "B");
			// SERIALIZED.set("enumInt", 1);
		}
	}
	...
	public void testEnumValues() {
		var de = ObjectDeserializer.standard();
		var deserialized = de.deserializeFields(EnumValues.SERIALIZED, EnumValues::new);
		assertEquals(new EnumValues(), deserialized);

		var ser = ObjectSerializer.standard();
		var serialized = ser.serializeFields(new EnumValues(), Config::inMemory);
		assertEquals(EnumValues.SERIALIZED, serialized);
